                          ...
                          padding: EdgeInsets.only(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SmallText(text: "With the Nigeria Characteristic"),
                                SizedBox(height: Dimensions.height10,),
  ...
  Widget _buildPageItem(int index,ProductModel popularProduct){
    ...
    return Transform(
        ...
        onTap: (){
         ...
         child: Container(
          ...
          decoration: BoxDecoration(
            ...
            color:index.isEven? 
            Color(0xFF69c5df) : Color(0xFF9294cc),
            image: DecorationImage(
              fit: BoxFit.cover,
              image: NetworkImage(
      ...
      Align(
        ...
        margin: EdgeInsets.only(left:Dimensions.width20, right:Dimensions.width30, bottom: Dimensions.height30),
        decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(Dimensions.radius30),
          color:Colors.white,
          boxShadow: [
